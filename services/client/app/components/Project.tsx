...
import { Stack, Flex, Text, Container, HStack, SimpleGrid, StackDivider, useColorModeValue, Image, VStack } from "@chakra-ui/react";
                ...
                <Stack spacing={4}>
                    ...
                    {devStack?.length && (
                        <>
                            ...
                            <HStack wrap={"wrap"} spacing={6} divider={<StackDivider borderColor={useColorModeValue("primary.300", "primary.700")} />}>
                                {devStack}
                            </HStack>
                        </>
                    )}
