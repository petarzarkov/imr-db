...
const Card: FC<{
    ...
    return (
        <Center>
            <Box maxW={"270px"} w={"full"} bg={useColorModeValue("primary.50", "primary.900")} boxShadow={"2xl"} rounded={"md"} overflow={"hidden"}>
                <Image h={"120px"} w={"full"} src={"images/dice.jpg"} objectFit={"cover"} />
                <Flex justify={"center"} mt={-12}>
                    <Avatar borderColor={useColorModeValue("primary.200", "primary.700")} borderWidth={2} borderStyle={"groove"} size={avatarSize} src={"images/avatar.jpg"} title={name} />
                </Flex>
...
const StatsCard: FC<{
    ...
    return (
        <Stat px={{ base: 2, md: 4 }} shadow={"xl"} border={"1px solid"} borderColor={useColorModeValue("primary.800", "primary.500")} rounded={"lg"}>
            <VStack>
                <Box>
