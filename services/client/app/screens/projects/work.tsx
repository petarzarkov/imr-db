...
export const work = (isFrameLoading: boolean, setFrameLoading: (l: boolean) => void): Parameters<typeof Project>[0][] => [
    {
        ...
        preview: (
            <AspectRatio w={{ base: isFrameLoading ? 400 : 256, md: 400, lg: 400 }} h={{ base: isFrameLoading ? 400 : 256, md: isFrameLoading ? 400 : 600, lg: isFrameLoading ? 400 : 600 }}>
                <>
        ...
        features: [
            {
                ...
                content: (
                    <Text fontWeight={600}>
                        Managed the project from start to finish including FE, BE, and CI/CD. Pytest was used for complete unit test coverage. AWS for billions of simulations to meet regulator
                        standards. Extra Stack: pyramid, venv
                    </Text>
                ),
            },
            {
